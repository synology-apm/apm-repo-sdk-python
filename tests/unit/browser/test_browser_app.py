...
def test_main_preloads_the_resource_tracker_before_running(monkeypatch: pytest.MonkeyPatch) -> None:
...
async def test_on_unmount_cancels_every_outstanding_job() -> None:
    class _FakeWorker:
